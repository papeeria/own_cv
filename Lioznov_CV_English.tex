...
\personalinfo{%
  ...
  \linkedin{\href{https://linkedin.com/in/lavton/}{linkedin.com/in/lavton/}}
  \github{\href{https://github.com/Lavton}{github.com/Lavton}}
  \vk{\href{https://vk.com/lavton}{vk.com/lavton}}
...
\cvsection[p1_side_engl.tex]{Work Experience}

\cvevent{intern programmer}{OKKO-movies}{2014, summer}{}
\begin{itemize}
\item Optimized work with external sources
\item Achieved acceleration of work time by order of magnitude
\item Improved search quality
\end{itemize}
\cvtag{Java} \cvtag{Grails} \cvtag{Postgresql} \cvtag{Git}
\divider

\cvevent{The task tester in physics}{Competentum}{2014, summer}{}
\begin{itemize}
\item Looked for errors in the conditions and decisions
\item Tested the work with the site from the perspective of the user
\end{itemize}
...
\begin{itemize}
\item Combined various ways of explaining the material
\item Completely prepared the program
\end{itemize}
...
\begin{itemize}
\item Created a site and automation systems
